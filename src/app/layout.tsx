...
export const metadata: Metadata = {
  title: "Volva Sh - Premium Car Rental Service",  description: "Rent luxury vehicles with Volva Sh. Wide selection of premium cars, competitive pricing, 24/7 support, and seamless booking experience.",  keywords: "car rental, luxury cars, vehicle rental, premium vehicles, affordable car hire",  metadataBase: new URL("https://volvash.com"),
  alternates: {
    canonical: "https://volvash.com"
  },
  openGraph: {
    title: "Volva Sh - Premium Car Rental",    description: "Experience luxury car rentals with Volva Sh. Best rates on premium vehicles.",    siteName: "Volva Sh",    type: "website",    images: [{
      url: "https://img.b2bpic.net/free-photo/black-sedan-wet-highway-rain-rainy-drive_169016-69903.jpg",      alt: "Premium luxury vehicle"
    }]
  },
  twitter: {
    card: "summary_large_image",    title: "Volva Sh Car Rental",    description: "Premium vehicle rentals at competitive prices",    images: ["https://img.b2bpic.net/free-photo/black-sedan-wet-highway-rain-rainy-drive_169016-69903.jpg"]
  }
};
